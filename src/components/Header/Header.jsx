...
const Header = () => {
    ...
    let {userName,setUserName , logout,setGlobalUser,  globalUser} = useContext(AuthContext)
    let {getCartCount} = useContext(ShopContext)
                            ...
                            {!globalUser ? (<Link to='/login'>
                                ...
                                <div className='flex items-center gap-2 group'>
                                    ...
                                    <div
                                        ...
                                        <div
                                            className='min-w-48 bg-stone-100 flex flex-col group gap-4 p-4 top-25 '>

                                            <p
                                                className='hover:text-black cursor-pointer'>Профиль</p>

                                            <p
                                                className='hover:text-black cursor-pointer'>Мои
                                                направления</p>
                                            <p onClick={logout}
                                               className='hover:text-black cursor-pointer'>Выйти</p>
                                        </div>
