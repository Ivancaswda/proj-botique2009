                    ...
                    <div className='flex flex-col gap-4 my-8'>
                        ...
                        <div
                            ...
                            {selectedPayment === 'sber' ? (
                                    <a className="no-underline hover:no-underline" href="https://www.sberbank.com/promo/sberpay">
                                <button
                                    ...
                                    <a className="no-underline hover:no-underline" style={{underline: 'none'}} href="https://www.tbank.ru/mybank/payments/">
                                            <button
                                ...
                                addToCart(productData._id, retOption);
                        ...
                        <div className='flex flex-col justify-between items-start mt-4'>
                            ...
                            <div className='flex items-center gap-5'>
                                ...
                                <button onClick={() => {
                                    setRetOption('15-дневной возможный возврат товара')
                                }}
                                ...
                                <button onClick={() => {
                                    setRetOption('11-дневной возможный возврат товара')
                                }}
                                ...
                                <button onClick={() => {
                                    setRetOption('5-дневной возможный возврат товара')
                                }}
